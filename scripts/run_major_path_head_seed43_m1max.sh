...
RUN_ROOT="reports/major_path_transition_head_seed43_v31_20260714"
LOG="ops/training/major_path_transition_head_seed43_m1max_20260714.log"
...
printf '%s\n' \
  '{"scope":"posthoc_research_only","target_version":"market_transition_v3_breadth_20260714","objective_version":"major_path_v31_20260714","seed":43,"test_used_for_selection":false,"live_orders_allowed":false}' \
...
printf '%s\n' "seed43 major-path v3.1 experiment complete" | tee -a "$LOG"
