...
RUN=v14_hidden_5fold_seed17_20260718
...
grep -q hidden_completion stock_v2/graph_jepa.py || { echo 'ABORT: hidden patch absent'; exit 1; }
...
echo "v14 5fold args verified: $(echo "$P" | wc -w) flags"
