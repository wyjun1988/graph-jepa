...
WAIT_MARKER="reports/classical_extra_trees_market_transition_v6_by_event_history_lags125_activity_pruned_v1_two_seed_20260714_COMPLETE"
RUN_PREFIX="classical_extra_trees_market_transition_v6_by_event_history_lags125_event_tuned_v1"
cd "$ROOT"
...
SMOKE="reports/${RUN_PREFIX}_smoke_20260714"
if [[ ! -f "$SMOKE/summary.json" ]]; then
  "$PYTHON_BIN" scripts/benchmark_classical_market_transition_head.py \
    --model-dir "$MODEL_ROOT/strict_causal453_path_v2_path_w12_p005_l025_skip_seed17_fold1_20231229_to_20241230" \
    --output-dir "$SMOKE" \
    --horizons 1,2,3,5,10 \
    --event-classifier-mode by_event \
    --event-model-selection per_event_validation_auc \
...
touch "reports/${RUN_PREFIX}_two_seed_20260714_COMPLETE"
