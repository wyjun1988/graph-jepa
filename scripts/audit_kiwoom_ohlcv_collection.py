...
from stock_v2.kiwoom_ohlcv_collection_audit import audit_kiwoom_ohlcv_collection


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Rebuild and audit a Kiwoom ka10081 collection from raw pages."
    )
...
def main() -> int:
    args = parse_args()
    report = audit_kiwoom_ohlcv_collection(
