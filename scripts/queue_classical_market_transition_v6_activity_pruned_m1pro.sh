...
WAIT_MARKER="reports/classical_extra_trees_market_transition_v6_by_event_history_lags125_feature_importance_20260714/EXPERIMENT_COMPLETE"
RUN_PREFIX="classical_extra_trees_market_transition_v6_by_event_history_lags125_activity_pruned_v1"
cd "$ROOT"
...
if [[ ! -f "$SMOKE/summary.json" ]]; then
  "$PYTHON_BIN" scripts/benchmark_classical_market_transition_head.py \
    ...
    --activity-feature-mode domain_pruned_v1 \
