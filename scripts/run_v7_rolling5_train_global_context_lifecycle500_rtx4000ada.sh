...
export ROOT
export RUN_NAME="${RUN_NAME:-broad_transition_jepa_v7_globalctx_aux_lifecycle500_seed17_rtx4000ada_20260715}"
export PREFLIGHT_NAME="${PREFLIGHT_NAME:-broad_transition_jepa_v7_globalctx_aux_lifecycle500_recipe_preflight_20260715}"
