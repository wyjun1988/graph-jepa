...
REPORTS_ROOT="reports/causal453_state_weight_ablation_m1_20260713"
MODELS_ROOT="models/causal453_state_weight_ablation_m1_20260713"
...
run_variant() {
  ...
  "$PYTHON" scripts/run_walk_forward_node_eval.py \
    ...
    --lr 0.0003 \
    --ema-decay 0.9995 \
    --state-loss-weight "$state_weight" \
...
run_variant causal453_state_w035_h256_l4_e6 0.35
run_variant causal453_state_w100_h256_l4_e6 1.0
