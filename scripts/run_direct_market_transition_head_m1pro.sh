...
RUN_ROOT="reports/direct_market_transition_head_seed17_v3_20260714"
LOG="ops/training/direct_market_transition_head_seed17_m1pro_20260714.log"
...
printf '%s\n' \
  '{"scope":"posthoc_research_only","target_version":"market_transition_v3_breadth_20260714","role":"same-objective direct causal comparator","test_used_for_selection":false,"live_orders_allowed":false}' \
...
printf '%s\n' "direct joint market-transition experiment complete" | tee -a "$LOG"
