...
RANK_POLICIES = [
    ...
    # 2026-08-03: 5폴드에서 30% 가 최고였는데 그게 그리드 끝이었다. SL-3% 를
    # "그리드 끝이라 못 믿는다"로 기각했던 것과 같은 자리다 — 끝을 열어 확인한다.
    ("랭크35 h10/h10",   "h10",  "h10",  0.35, 30),
    ("랭크40 h10/h10",   "h10",  "h10",  0.40, 30),
    ("랭크50 h10/h10",   "h10",  "h10",  0.50, 30),
