...
WAIT_MARKER="reports/cached_raw_market_transition_head_v6_epoch008_20260714/WEIGHTED_SEED2701_RERUN_COMPLETE"
RUN_PREFIX="classical_extra_trees_market_transition_v6_history_lags125"
cd "$ROOT"
