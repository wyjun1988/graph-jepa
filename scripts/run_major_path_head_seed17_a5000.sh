...
RUN_ROOT="reports/major_path_transition_head_seed17_v31_20260714"
LOG="ops/training/major_path_transition_head_seed17_a5000_20260714.log"
...
WAIT_MARKER="reports/major_node_transition_shape_seed17_v3_20260714/EXPERIMENT_COMPLETE"
...
printf '%s\n' \
  '{"scope":"posthoc_research_only","target_version":"market_transition_v3_breadth_20260714","objective_version":"major_path_v31_20260714","objective":"fit-top-decile path rank, event, and peak horizon","test_used_for_selection":false,"live_orders_allowed":false}' \
...
run_fold() {
  ...
  "$PYTHON_BIN" scripts/benchmark_major_path_transition_head.py \
...
printf '%s\n' "seed17 major-path v3.1 experiment complete" | tee -a "$LOG"
