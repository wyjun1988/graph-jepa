...
WAIT_MARKER="reports/market_transition_v6_state_feature_contribution_audit_20260714/EXPERIMENT_COMPLETE"
RUN_PREFIX="classical_extra_trees_market_transition_v6_by_event"
cd "$ROOT"
