...
RUN_ROOT="reports/major_node_transition_shape_v6_seed43_20260714"
LOG="ops/training/major_node_transition_shape_v6_seed43_20260714_m1max.log"
...
printf '%s\n' "v6 seed43 major node-transition shape evaluation complete" | tee -a "$LOG"
