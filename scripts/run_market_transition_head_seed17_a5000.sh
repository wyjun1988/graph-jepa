...
RUN_ROOT="reports/market_transition_head_seed17_v3_20260714"
LOG="ops/training/market_transition_head_seed17_a5000_20260714.log"
...
printf '%s\n' \
  '{"scope":"posthoc_research_only","target_version":"market_transition_v3_breadth_20260714","objective":"joint-horizon broad market transition prediction","family_event_quantile":0.95,"test_used_for_selection":false,"live_orders_allowed":false}' \
...
printf '%s\n' "seed17 joint market-transition experiment complete" | tee -a "$LOG"
