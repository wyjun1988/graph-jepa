...
RUN_ROOT="reports/direct_major_path_transition_head_seed17_v31_20260714"
LOG="ops/training/direct_major_path_transition_head_seed17_m1pro_20260714.log"
...
printf '%s\n' \
  '{"scope":"posthoc_research_only","target_version":"market_transition_v3_breadth_20260714","objective_version":"major_path_v31_20260714","role":"same-objective robust direct comparator","test_used_for_selection":false,"live_orders_allowed":false}' \
...
run_fold() {
  ...
  "$PYTHON_BIN" scripts/benchmark_direct_major_path_transition_head.py \
...
printf '%s\n' "direct major-path v3.1 experiment complete" | tee -a "$LOG"
